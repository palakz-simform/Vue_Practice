    ...
    <div class="flex flex-nowrap gap-4 items-center">
      ...
      <button type="button" @click.prevent="playerStore.toggleAudio">
        <i class="fa text-gray-500 text-xl"
          :class="{ 'fa-play': !playerStore.playing, 'fa-pause': playerStore.playing }"></i>
      </button>
      <!-- Current Position -->
      ...
      <div @click.prevent="playerStore.updateSeek" class="w-full h-2 rounded bg-gray-200 relative cursor-pointer">
        <!-- Player Ball -->
        <span class="absolute -top-2.5 -ml-2.5 text-gray-800 text-lg" :style="{ left: playerStore.playerProgress }">
